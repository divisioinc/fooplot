...
function Fooplot(container, options) {
  ...
  this.getRealGrid = function () {
    ...
    if (parseFloat(this.xgrid)) {
      ...
      if (rem > 0.7) realxgrid *= 5;else if (rem > 0.3) realxgrid *= 2;
    }
    ...
    if (parseFloat(this.ygrid)) {
      ...
      if (rem > 0.7) realygrid *= 5;else if (rem > 0.3) realygrid *= 2;
    }
  ...
  this.drawLabels = function () {
    ...
    this.context.font = "14px Droid Sans,Trebuchet MS,Arial,Helvetica,sans-serif";
...
function main() {
  ...
  myPlot.addPlot("csch(x)", _constants.FOOPLOT_TYPE_FUNCTION);
  myPlot.reDraw();
}
